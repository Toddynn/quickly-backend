...
export class ListOrganizationAddressesController {
	...
	async execute(
		...
		@Query() listDto: ListOrganizationAddressesDto,
	): Promise<PaginatedResponseDto<ListOrganizationAddressResponseDto>> {
		return await this.listOrganizationAddressesUseCase.execute({
			...listDto,
