...
import type { UserWithoutPassword } from '../models/interfaces/user-without-password.interface';
...
export class UsersRepository extends Repository<User> implements UsersRepositoryInterface {
	...
	async listAllUsersPaginated({ page = 1, limit = 10, search }: PaginationDto): Promise<PaginatedResponseDto<UserWithoutPassword>> {
